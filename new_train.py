...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="deepspeek-ai/deepspeek-coder-6.7b-instruct")
...
def _tokenize_fn(strings: Sequence[str], tokenizer):
    ...
    input_ids_lens = labels_lens = [
        tokenized.input_ids.ne(tokenizer.pad_token_id).sum().item() for tokenized in list
    ]
    return dict(
        input_ids=input_ids,
        labels=labels,
