...
# BEFORE CHANGES MADE TO THE CODE BELOW THE CODE WAS WORKING FINE. before programming keywords filtered only
"""
import os
import random
import logging
...
# IM NOT SURE IF THIS IS ACTUALLY THE BEST WAY OF DOING THIS BUT IT DOES SEEM TO WORK SO FAR. IM COMBINING THE USER QUERY AND THE EXPLANATION TO FIND THE KEYWORDS AND THEN USING THESE KEYWORDS TO FIND RELATED CODE EXAMPLES.
